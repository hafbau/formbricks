...
const nextConfig = {
  ...
  transpilePackages: ["@fastform/ui", "@fastform/lib"],
  images: {
    remotePatterns: [
      {
        protocol: "https",
  ...
  async redirects() {
    return [
      ...
      {
        source: "/roadmap",
        destination: "https://github.com/orgs/fastform/projects/1",
        permanent: true,
      },
      {
        source: "/github",
      ...
      {
        source: "/docs",
        destination: "/docs/introduction/what-is-fastform",
        permanent: true,
      },
      ...
      {
        source: "/docs/fastform-hq/self-hosting",
        destination: "/docs",
        permanent: true,
      },
      {
      ...
      {
        source: "/docs/fastform-hq/schema",
        destination: "/docs",
        permanent: true,
      },
      {
      ...
      {
        source: "/launch",
        destination: "https://www.producthunt.com/posts/fastform",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: "https://app.fastform.com/s/clhys1p9r001cpr0hu65rwh17",
        permanent: true,
      },
      {
  ...
  async rewrites() {
    return {
      fallback: [
        ...
        {
          source: "/:path*",
          destination: `https://app.fastform.com/s/:path*`,
        },
      ],
    };
  },
...
export default withPlausibleProxy({ customDomain: "https://plausible.fastform.com" })(
