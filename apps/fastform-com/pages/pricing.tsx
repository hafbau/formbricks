...
const linkSurveys = {
  ...
  features: [
    ...
    { name: "Remove Fastform Branding", free: false, paid: true },
  ],
...
const PricingPage = () => {
  return (
    <Layout
      title="Pricing | Fastform Open Source Experience Management"
      description="All our plans start free - choose what's best for you!">
      {/* Fastform Unlimited Deal */}
      {/* <div className="relative isolate mx-5 mt-8 overflow-hidden rounded-lg bg-slate-50 px-3 pt-4 shadow-2xl dark:bg-slate-800 sm:px-8 md:pt-8 lg:gap-x-10 lg:px-12 lg:pt-0">
        ...
        <div className="mb-8 mt-2 items-center justify-center">
          <Button className="w-full justify-center py-2 shadow-sm" href="https://app.fastform.com/">
            Get Started
          </Button>
        </div>
      </div> */}
