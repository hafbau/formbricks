...
export default function InterviewPromptPage() {
  return (
    <Layout
      title="Interview Prompt with Fastform"
      ...
      <div className="grid grid-cols-1 items-center md:grid-cols-2 md:gap-12 md:py-20">
        <div className="p-6 md:p-0">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Once you have setup the Fastform Widget, you have two ways to pre-segment your user base: Based on
            events and based on attributes. Soon, you will also be able to import cohorts from PostHog with
            just a few clicks.
          </p>
