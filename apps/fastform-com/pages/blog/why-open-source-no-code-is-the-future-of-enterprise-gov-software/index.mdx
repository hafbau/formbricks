...
import HeaderImage from "./fastform-logo.svg";
...
> In Germany, cities, municipalities and states have to choose the open source alternative, when there is one. In Europe, 49% of public institutions use OSS according to a form from the University of Maastricht.
...
<Image src={HeaderImage} alt="Fastform - Open Source Forms & Surveys" className="w-full" />
