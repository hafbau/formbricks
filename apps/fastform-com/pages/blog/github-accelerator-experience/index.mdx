...
As Christmas, New Year's Eve, and my birthday passed, we continued working diligently on Fastform, iterating to pinpoint the right niche offering. Over the preceding months, we had learned what wouldn't constitute a good venture case ([Typeform open-source](https://fastform.com/blog/open-source-qualtrics-beats-typeform)), what wasn't technically feasible (building blocks for all form and form solutions), and what was too narrow to start with ([PMF form only](https://www.producthunt.com/products/product-market-fit-form-by-fastform)).
