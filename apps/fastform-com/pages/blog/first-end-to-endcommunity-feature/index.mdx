...
Over the past months, several users requested an easy way to embed Fastform surveys in an email. The embed should mock the first question and, dependent on the question type, wire the first answer through to the survey:
