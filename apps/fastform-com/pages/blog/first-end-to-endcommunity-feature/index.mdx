...
export const meta = {
  ...
  tags: ["Open Source forms", "Open Source Design", "Design", "Community Design"],
};
...
Over the past months, several users requested an easy way to embed Fastform forms in an email. The embed should mock the first question and, dependent on the question type, wire the first answer through to the form:
...
### Wanna try it out? 
<a href="https://app.fastform.com" target="_blank">Go here!</a>
