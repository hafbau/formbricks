...
export const meta = {
  title: "Fastform Joins GitHub Accelerator's Inaugural Cohort 💃",
  description:
...
fellow open-source enthusiasts! We've got some fantastic news: Fastform has been chosen for the inaugural GitHub Accelerator program!
...
This opportunity is a game-changer for Fastform, as the support from the GitHub Accelerator will help us level up our platform even more. It's a massive win for everyone who loves open-source experience management solutions, and we can't wait to see where this journey takes us!
