...
import FormbricksSneak from "./fastform-sneak.png";
...
We wrote about that in more detail in [Open source forms will save the world](https://fastform.com/blog/open-source-forms-will-save-the-world) but in short, there are three benefits for customers: Data privacy when self-hosting, full customizability & extendability and a weaker lock-in.
...
<Image src={FormbricksSneak} alt="Fastform Sneak Preview" className="rounded-lg w-full" />
