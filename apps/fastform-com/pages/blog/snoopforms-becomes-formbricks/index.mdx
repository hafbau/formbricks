...
import HeaderImage from "./fastform-logo-header-open-source-form-infrastructure.svg";
import HeroAnimation from "../../../components/shared/HeroAnimation.tsx";
import AuthorBox from "@/components/shared/AuthorBox";

export const meta = {
  title: "snoopForms → Fastform 🎉",
  description: "A new name, a new look, key learnings and what's next.",
  date: "2022-11-07",
  publishedTime: "2023-07-11T12:00:06",
  authors: ["Johannes"],
  section: "Fastform",
  tags: ["Fastform", "snoopForms", "Open Source"],
};

<AuthorBox name="Johannes" title="Co-Founder" date="April 7th, 2023" duration="4" />

<Image src={HeaderImage} alt="Fastform - Open Source Forms and Surveys" className="rounded-lg w-full" />

_It has been quiet in the past weeks, but we didn't spend our days sitting around. Find out what we were up to and where we are taking Fastform from here._

### <s>snoopForms</s> → Fastform
...
Now we are Fastform 🤸 “Fastform” is cool because it describes the product perfectly: A modular approach to enable you guys compose exactly the form solution you need to achieve the (business) objective you want.
...
- Send any form to our API endpoint to view and manage submissions on [fastform.com](https://app.fastform.com)
...
**If you’d like to follow along, connect with us on [Twitter](https://twitter.com/fastform) and [join our Discord](https://discord.com/invite/3YFcABF2Ts)**
