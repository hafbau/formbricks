...
import TitleImage from "../github-accelerator-experience/fastform-sponsored-by-github-accelerator-2023.webp";
import PMFDashboard from "./pmf-form-dashboard.png";
import MattiJojo from "./matti-jojo.jpg";

export const meta = {
  title: "Fastform v1 - How we got here 🤸",
  description:
    "A lot has happened since Matti and I had a chat about open-source forms in May last year. The release of Fastform v1.0 is a perfect opportunity to look back on how it all started.",
  date: "2023-07-14",
  publishedTime: "2023-07-14T08:10:33",
  authors: ["Johannes"],
  section: "Open Source Experience Management",
  tags: ["Open Source", "Experience Management", "Fastform"],
};

<AuthorBox name="Johannes" title="Co-Founder" date="April 7th, 2023" duration="4" />

_A lot has happened since Matti and I had a chat about open-source forms in May last year. The release of Fastform v1.0 is a perfect opportunity to look back on how it all started._
...
Well no, it is not. Apart from the Early Birds (🤍) we attracted a looooooooot of people who liked Typeform, but didn’t want to pay the high price tag. Generally, it's not the best idea to build a product with high competition (100s of form tools) for a price-sensitive target group. Even data privacy isn’t a good selling point when Jotform offers self-hosting and Typeform is an EU-based company (GDPR). We’ve written **[in-depth](https://fastform.com/blog/open-source-qualtrics-beats-typeform)** about why we eventually decided to shift our focus away from open-source Typeform.

Nonetheless, we were hooked on open-source forms; we just hadn't found the right application yet.

### **snoopForms → Fastform, a detour, and going full-time**

We decided to wrap up our freelance gigs and go in full-time, to find the right angle quicker. We built a MVP for _Building Bricks for Forms and forms_, but while the idea made sense, we struggled to build an easy, opionated solution which can be used for several use cases. To help engineers build form and form applications faster, it needed to pack form creation, form analytics, graphs, data handling, data storage, analysis, integrations, and ways to act on the insights for a variety of use cases 🤷 There's a reason why successful dev tools focus on one of these aspects and do them well. So we kept looking…

### **Data Processing vs. Experience Management**

We had talked to and formed a lot of people. Zooming out, we saw that there are two applications for forms: data processing and experience management.
...
### **The Product-Market Fit Form Tool**
...
<Image
  ...
  className="rounded-lg w-full"
/>
_We built a custom dashboard just to visualize the PMF form results_
...
- The PMF form is for teams that "kinda" have PMF, not for teams which are just starting out. You need a few hundred recurring users in your app to be able to reach statistical significance and run the form every 3 months without asking anyone twice. For teams who don’t have that, talking to users 1:1 will remain the best way to go.
- Founders were reluctant to add another tool just for one form and purpose.

After the rather disappointing launch of the PMF form tool, we hit a low. The excitement about the initial snoopForm traction had passed. Since November, we had been working full-time for four months iterating on different products in the forms and form space, and it didn’t feel like we made much progress. But that wasn’t really true.
...
With snoopForms, we learned that there is a latent need for an open-source standalone form tool, with a Typeform-like feature set: It’s a great opportunity to build a community and **not** a great business opportunity. The PMF form tool taught us about the needs of early-stage teams and that forms are **not** the best solution to their problems. However, they do need some form to gather qualitative feedback and a smooth way to work with it 😏

We took everything we knew and wrote a Masterplan. And then we sat down coded.

### **Open-source in-product forms**

March and the first half of April flew by as we hacked together the MVP of what Fastform is today: A tool which enables teams to target specific segments of their user base with versatile micro-forms. Matti solved some tricky technical challenges around the Fastform Widget and shipped the backend. ChatGPT and I warmed up with next.js and built frontend. Seeing the product come together was fun and felt like progress - exactly what we needed!

<Image
  src={TitleImage}
  alt="GitHub sponsors Fastform to join their open-source accelerator program"
  className="rounded-lg w-full"
/>

A welcomed motivator came in the form of an email from GitHub: We we were chosen to take part in the first-ever batch of the GitHub Open-Source Accelerator! It was a really fun programme and we learned a lot! You can read about our experience [here.](https://fastform.com/blog/github-accelerator-experience)

### **On the right track 🚆**

Once we were ready to share our MVP with the world, we knew we were on the right track! The feedback was really good and usage picked up right from the start. One morning we woke up to our analytics dashboard showing thousands of form displays with 500+ responses in the past couple of hours! This is when we knew we’re onto something 🚀

A couple of weeks later, Peer from [Cal.com](http://Cal.com) came back to northern Germany to visit his family and friends. We hung out in the co-working space, where he did his first steps as an entrepreneur. As we were chatting about how to separate opinion from experience, Peer decided to shoot an email with a form to the 12k most active users of Cal.com. A few days before, he asked his Twitter following the PMF question:
...
We wanted to compare how the publicly asked form (Twitter) compared to a form among the community of users. The results were eye-opening:
...
For us, this was not only a good test for our system but it was a great example that Experience Management does not only happen within apps, but on several touch points right from the start. If we want to offer a solution which can comprehensively measure and evaluate experiences, it cannot be confined to in-product forms for too long.

### **Typeform sneaking back in?**

Given our early traction with snoopForms, it’s not a big surprise that community requests for a Typeform-like standalone form popped up more and more. Since we had all the pieces in place, we shipped standalone forms in a day. However, it’s not our focus right now, so we hand over most of the feature requests to the community. And the community ships! Just in the past couple of weeks, we got:

- **Prefill Data in Link forms** by Piyush - [Docs](https://fastform.com/docs/link-forms/data-prefilling)
- **Identify Users Link identification** by Zorig - [Docs](https://fastform.com/docs/link-forms/user-identification)
- **Close Form on Date** by Piyush
- **Close Form after x Responses** by Pradumn
- **Redirect on Link Form Completion** by Dhruwang
- **Embed Link Form via iframe** by Ankur
- **Set Custom ‘Form Closed’ Message** by Pradumn
- **Randomize Answer Options** by Shubdeep

We absolutely love the idea of being the platform for a community-developed standalone form experience! It’s a win-win: The community gets a free, self-hostable standalone form product and we get a growing upper funnel for our Experience Management solution 🤸

### **It’s coming together 🔥**

Looking back at the amount of value Fastform can deliver after not even 5 months fills us with excitement. Matti and I have been hacking it together for the most part but we wouldn’t be anywhere nearly as close without the support of our community and friends - thank you!

And we’re only getting started: We were able to hire two engineers from our community of contributors to build up more shipping velocity. We also started working with Kristian who runs our [open-source Design repo](https://github.com/fastform/design) more closely and are super excited about what we’re cooking up. We’ll make sure Fastform stays easy-to-use, accessible and simply beautiful as it grows more powerful! We can't tell you how excited we are about what's coming 😁

If you’re curious to learn about all the things you can do with Fastform today, we’ve written and keep updating a list of Best Practices incl. form templates in our [Docs](https://fastform.com/docs/best-practices/cancel-subscription).

### Sounds good? **Build with us!**

- **Eager to contribute?** [Join our Discord](https://fastform.com/discord) and say Hi! We’re more than happy to find the perfect issue for your level of experience 🙌 😊
