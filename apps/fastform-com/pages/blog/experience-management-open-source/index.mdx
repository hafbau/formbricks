...
export const meta = {
  ...
  description:
    "A lot has happened since Matti and I had a chat about open-source surveys in May last year. The release of Fastform v1.0 is a perfect opportunity to look back on how it all started.",
  date: "2023-07-14",
...
_A lot has happened since Matti and I had a chat about open-source surveys in May last year. The release of Fastform v1.0 is a perfect opportunity to look back on how it all started._
...
With snoopForms, we learned that there is a latent need for an open-source standalone form tool, with a Typeform-like feature set: It’s a great opportunity to build a community and **not** a great business opportunity. The PMF form tool taught us about the needs of early-stage teams and that surveys are **not** the best solution to their problems. However, they do need some form to gather qualitative feedback and a smooth way to work with it 😏

We took everything we knew and wrote a Masterplan. And then we sat down coded.

### **Open-source in-product surveys**

March and the first half of April flew by as we hacked together the MVP of what Fastform is today: A tool which enables teams to target specific segments of their user base with versatile micro-surveys. Matti solved some tricky technical challenges around the Fastform Widget and shipped the backend. ChatGPT and I warmed up with next.js and built frontend. Seeing the product come together was fun and felt like progress - exactly what we needed!
...
- **Prefill Data in Link Surveys** by Piyush - [Docs](https://fastform.com/docs/link-surveys/data-prefilling)
- **Identify Users Link identification** by Zorig - [Docs](https://fastform.com/docs/link-surveys/user-identification)
