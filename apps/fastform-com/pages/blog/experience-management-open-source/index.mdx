...
A welcomed motivator came in the form of an email from GitHub: We we were chosen to take part in the first-ever batch of the GitHub Open-Source Accelerator! It was a really fun programme and we learned a lot! You can read about our experience [here.](https://getfastform.com/blog/github-accelerator-experience)
...
- **Prefill Data in Link forms** by Piyush - [Docs](https://getfastform.com/docs/link-forms/data-prefilling)
- **Identify Users Link identification** by Zorig - [Docs](https://getfastform.com/docs/link-forms/user-identification)
...
If you’re curious to learn about all the things you can do with Fastform today, we’ve written and keep updating a list of Best Practices incl. form templates in our [Docs](https://getfastform.com/docs/best-practices/cancel-subscription).

### Sounds good? **Build with us!**

- **Eager to contribute?** [Join our Discord](https://getfastform.com/discord) and say Hi! We’re more than happy to find the perfect issue for your level of experience 🙌 😊
