...
export const meta = {
  ...
  authors: ["Johannes"],
  section: "Open Source Form Tool",
  tags: ["Open Source", "Form Tool", "Forms"],
};
...
Lastly, forms are sticky and viral. Once people set up their forms and forms, they are hesitant to change, unless there is a very good reason to do so (i.e. full data ownership or outrageous pricing). As users share around their forms and forms, our brand naturally starts popping up all over the internet ✅
