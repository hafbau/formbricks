...
export default function DocsFeedbackPage() {
  return (
    <Layout
      title="Get User Feedback in the easiest way possible with Fastform"
      ...
      <div className="grid grid-cols-1 items-center md:grid-cols-2 md:gap-12 md:py-20">
        <div className="p-6 md:p-0">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            As of now, Docs Feedback uses custom UI in the frontend and Fastform in the backend. A partial
