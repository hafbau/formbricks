...
const XMOffer = [
  ...
  },
  {
    ...
    description: "Our core developers help you get Fastform up and running in no more than 60 minutes.",
  },
  {
    step: "5",
...
const ConciergePage = () => {
  ...
  return (
    <Layout
      title="Concierge | Fastform Open Source Experience Management"
