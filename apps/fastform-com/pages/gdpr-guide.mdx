...
export const meta = {
  ...
  description: "Steps to understand how GDPR might be needed for you with Fastform.",
};
...
## **Creating a GDPR compliant form with Fastform**

In our [Privacy Policy](/privacy-policy) we inform you about your rights and responsibilities using Fastform. A quick recap: You are the data controller of the data you collect from your respondents using Fastform forms and surveys. We are the data processor.
