...
export const meta = {
  ...
  description: "Fastform Privacy Policy",
};
...
This Privacy Policy explains how and why our organization collects personal data and how it is used. If you have any questions after reading this Privacy Policy, feel free to contact us at **privacy@fastform.com**

### Important Notice

This Privacy Policy only applies to the Fastform Cloud under [app.fastform.com](https://app.fastform.com) (”Cloud”) and our Landing Page under fastform.com. (”Landing Page”) If you are self-hosting our open source tool on your own servers, this Privacy Policy does not apply.

### Definitions

To avoid confusion, let’s define who we collect data from:

- Researcher: the person who uses the Cloud to create and distribute Fastform forms and surveys or manage submissions from other forms
- Website visitors: People who visit our marketing landing page

### We are data processor, you are data controller

With our Cloud we are a provider of this Service. We are not the owner of the collected personal data from form respondents. The Researcher (the person who sends out a form i.e. you) is responsible for the data they collect and thus data controller of respondent data.
...
- **Billing information:**
  If you pay for Fastform, we will ask for your billing details including name, address and financial information depending on your payment method (stored by our payment service provider Stripe)
- **Form data:**
  We store your form data (questions and responses) for you and provide tools for you to analyse and use this data.
- **Error logs:**
  We collect error logs to help us diagnose and fix issues with our service.

## **How we use your data**

Fastform does not sell personal data to third parties. Generally, we only collect your data with your consent in order to:
...
If you are a Fastform Researcher we do not delete the data in your account. You can delete data in your Fastform account. You are responsible for the time period for which you store the data.

If you are a Respondent, you will need to ask the Researcher how long your responses will be stored in Fastform.
...
Fastform Researchers can exercise their rights directly with us.

If you’ve submitted your personal data through a Fastform form, the Researcher who created the form is responsible for the collected data. Fastform only processes the data. Respondents should contact the person or organization which created the form. If this isn't possible, please contact us. We'll help in any way we can.
...
If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at hola@fastform.com.
...
- Users are able to change their personal information by emailing us at hola@fastform.com
...
To exercise your California data protection rights described above, please send your request(s) by email to hola@fastform.com.
...
If Researchers register to Fastform, we may send them emails about company news, updates, related product or service information, etc. Researchers can always opt out of the email communications.

## **Cookies**

Cookies are small text files that are placed on your computer or mobile device by websites you visit. They are widely used in order to make a website work, or work more efficiently, as well as to provide information to the owners of the site. Fastform uses cookies to improve your experience on our website and with our product.

Fastform uses cookies to improve your user experience, including:

- Keeping you signed in
- Understanding how you use our product

### What types of cookies does Fastform use?
...
Fastform is based in the EU and all form and user data is stored in Germany, EU. Only billing information processed by Stripe Inc. and anonymized personal data neccessary to provide this Service may be transfered overseas.

## **Users Acceptance Of These Terms**

By using Fastform, Researchers signify their acceptance of this policy. If Researchers do not agree to this policy, they should not use Fastform. Researchers continued use of Fastform following the posting of changes to this policy will be deemed their acceptance of those changes.
