...
/* const SideQuests = [
  ...
  },
  {
    ...
    quest:
      "Create a branded gif related to Fastform. Upload it to Giphy. For extra points, tweet it, tag us and score +5 for each like.",
...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "We offer a Fastform Cloud hosted in Germany with a generous free plan but you can also easily self-host using Docker.",
  },
  {
    ...
    <LayoutTribe
      ...
      <div
        ...
        <div className="py-16 md:py-24">
          <h2 className="mt-10 text-2xl font-bold text-slate-800 sm:text-3xl md:text-4xl">
            <span className="xl:inline">
              Become a<br className="md:hidden"></br> Fastform Legend
            </span>
          </h2>
          <p className="xs:max-w-none mx-auto mt-3 max-w-xs text-base text-slate-600 sm:text-lg md:mt-6 md:text-xl">
      ...
      <div className="mt-16" id="side-quests">
        ...
        <Button
          variant="darkCTA"
          href="https://fastform.notion.site/FormTribe-Side-Quests-4ab3b294cfa04e94b77dfddd66378ea2?pvs=4"
          target="_blank"
