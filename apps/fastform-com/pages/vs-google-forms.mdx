...
<Image
  src={HeaderImage}
  alt="Google Forms open source alternative comparison Fastform survey solution"
...
Fastform on the other hand, at the current state of development, is only an option if you are able to code your own form or survey with React. If this is an option for you, we prepared an [in-depth comparison](/best-react-form-library-2023) of Fastform React with other popular React libraries.
