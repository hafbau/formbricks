...
export default function FeedbackBoxPage() {
  return (
    <Layout
      title="Feedback Box with Fastform"
      ...
      <div className="grid grid-cols-1 items-center md:grid-cols-2 md:gap-12 md:py-20">
        <div className="p-6 md:p-0">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            ...
            Fastform automations, you&apos;ll be able to react to feedback rapidly. Lastly, critical feedback
            can be acted upon quickly so that it doesn&apos;t end up on social media.
          </p>
          <h3 className="text-md mb-1.5 mt-6 font-semibold text-slate-800 dark:text-slate-200">
            How to get started:
          </h3>
          <p className="text-slate-600 dark:text-slate-400">
            Setting up a Feedback Widget with Fastform takes just a few minutes. Create an account, customize
            your widget and choose the right settings so that it always pops up when a user hits
            &quot;Feedback&quot;.
          </p>
