...
export const metadata = {
  ...
  description: "Discover how to seamlessly integrate Fastform with Make.com. Dive into our comprehensive guide to set up scenarios, connect with a plethora of apps, and send your survey data to more than 1000 platforms.",
};
