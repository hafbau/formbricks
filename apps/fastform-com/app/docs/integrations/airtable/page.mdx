...
Before the next step, make sure that you have a Fastform Survey with at least one question and a Airtable base with atleast one table in the Airtable account you integrated.
...
7. Select the Base and table you want to link with Fastform and the Survey. On doing so, you will be asked with what questions' responses you want to feed in Airtable. Select the questions and click on the "Save" button.
...
Congratulations! You have successfully linked an Airtable with Fastform. Now whenever a response is submitted for the linked Survey, it will be automatically added to the linked Airtable.
