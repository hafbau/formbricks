...
import AddFastformTrigger from "./add-fastform-trigger.png";
...
<Image src={AddFastformTrigger} alt="Add Fastform Trigger" quality="100" className="rounded-lg max-w-full sm:max-w-3xl" />
