...
export const metadata = {
  title: "Fastform Quickstart Guide: In-App forms Made Simple",
  description:
...
In app forms have 6-10x better conversion rates than emailed out forms. This tutorial explains how to run an in app form in your web app in 10 to 15 minutes. Let’s go!
