...
for something else, please [join our Discord!](https://fastform.com/discord) and we would be glad to help. {{ className: 'lead' }}
...
```tsx {{title: 'Typescript'}}
// other imports
import FormbricksProvider from "./fastform";
