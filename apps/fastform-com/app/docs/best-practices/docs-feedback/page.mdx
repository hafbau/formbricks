...
Locate that file. We are using the [Tailwind Template “Syntax”](https://tailwindui.com/templates/syntax) for our docs. Here is our [Layout.tsx](https://github.com/hafbau/formbricks/blob/main/apps/fastform-com/components/docs/Layout.tsx) file.
