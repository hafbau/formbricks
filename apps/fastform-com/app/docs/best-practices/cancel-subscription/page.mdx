...
1. Create new Churn Survey at [app.fastform.com](http://app.fastform.com/)
...
<Note>
  ## Fastform Widget running? 
  You need to have the Fastform Widget installed to display the Churn Survey in your app. Please follow [this
