...
import Publish from "./publish-form.webp";
...
export const metadata = {
  ...
  description: "Engage with your power users seamlessly using Fastform' In-app Interview Prompt. Ditch traditional email invites and experience way more more respondents. Dive into our comprehensive guide on setting up auto-scheduled interviews today and enhance your user understanding",
};
...
Product analytics and in-app forms are incomplete without user interviews. Set the scheduling on autopilot for a continuous stream of interviews.
...
1. Create new Interview Prompt at [app.fastform.com](http://app.fastform.com/)
...
Click on "Create Form" and choose the template “Interview Prompt”:
...
<Note>
  ...
  You can also create [Code Actions](/docs/actions/code) using `fastform.track("Eventname")` - they will automatically
...
1. **pageURL:** Whenever a user visits a page the form will be displayed, as long as the other conditions match. Other conditions are pre-segmentation, if this user has seen a form in the past 2 weeks, etc.
...
Scroll down to “Recontact Options”. Here you have to choose the correct settings to strike the right balance between asking for user feedback and preventing form fatigue. Your settings also depend on the size of your user base or segment. If you e.g. have thousands of “Power Users” you can easily afford to only display the prompt once. If you have a smaller user base you might want to ask twice to get a sufficient amount of bookings:
