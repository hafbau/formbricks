...
export const metadata = {
  title: "How to Set Up a Product-Market Fit Survey Using Fastform - Step-by-Step Guide",
  description: "Learn to leverage Fastform to create and implement a Product-Market Fit survey in your web app. Follow our detailed step-by-step guide to measure and understand your PMF effectively. Ensure high data quality, efficient triggers, and actionable insights.",
};
...
1. Create new Product-Market Fit survey at [app.fastform.com](http://app.fastform.com/)
