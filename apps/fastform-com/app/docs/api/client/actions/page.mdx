...
export const metadata = {
  ...
  description:
    "Unlock the full potential of Fastform' Client Actions API. Create Actions right from the API.",
};
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location --request POST 'https://app.fastform.com/api/v1/client/<environment-id>/actions' \
    --data-raw '{
        "userId": "1",
        "name": "new_action_v2",
        "properties":{}
