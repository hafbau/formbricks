...
export const metadata = {
  title: "Fastform Public Client API Guide: Manage Form Displays & Responses",
  description:
    "Dive deep into Fastform' Public Client API designed for customisation. This comprehensive guide provides detailed instructions on how to mark create and update form displays for users.",
};
...
<Row>
  <Col>
    ...
    Create Display of form for a user

    ### Mandatory Request Body JSON Keys
    <Properties>
      <Property name="formId" type="string">
        Form ID to mark as viewed for a person
      </Property>
    </Properties>
    ...
    <Properties>
      <Property name="userId" type="string">
        Already existing user's ID to mark as viewed for a form
      </Property>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST \
    'https://app.fastform.com/api/v1/client/displays' \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST \
    'https://app.fastform.com/api/v1/client/<environment-id>/displays/<display-id>' \
    -H 'Content-Type: application/json' \
    -d '{
        "userId":"<user-id>"
      }'
