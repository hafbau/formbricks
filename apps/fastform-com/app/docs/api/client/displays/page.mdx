...
export const metadata = {
  title: "Fastform Public Client API Guide: Manage Survey Displays & Responses",
  description:
    "Dive deep into Fastform' Public Client API designed for customisation. This comprehensive guide provides detailed instructions on how to mark create and update survey displays for users.",
};
