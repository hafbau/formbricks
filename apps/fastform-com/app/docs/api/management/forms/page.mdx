...
export const metadata = generateManagementApiMetadata("forms", ["Fetch", "Create", "Update", "Delete"]);
...
- [Get Form](#get-form-by-id)
- [Create Form](#create-form)
- [Update Form](#update-form-by-id)
- [Delete Form](#delete-form-by-id)

<Note>You will need an API Key to interact with these APIs.</Note>

---

## List all forms {{ tag: 'GET', label: '/api/v1/management/forms' }}

<Row>
  <Col>

    Retrieve all the forms you have for the environment.
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/api/v1/management/forms">

    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/forms' \
    --header \
...
## Get Form by ID {{ tag: 'GET', label: '/api/v1/management/forms/<form-id>' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/api/v1/management/forms/<form-id>">

    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/forms/<form-id>' \
    --header \
    'x-api-key: <your-api-key>'
    ```
...
## Create Form {{ tag: 'POST', label: '/api/v1/management/forms' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="POST" label="/api/v1/management/forms">
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://app.fastform.com/api/v1/management/forms/ \
     --header 'Content-Type: application/json' \
     --header 'x-api-key: <your-api-key>' \
     -d '{"environmentId": "cln8k0t47000fz87njmmu2bck", "name": "My Form from API", "type": "link"}'
    ```
...
## Update Form by ID {{ tag: 'PUT', label: '/api/v1/management/forms/<form-id>' }}
...
<Row>
  <Col>
    ...
    ```json {{ title: 'cURL' }}
    {
        "name": "My renamed Form",
        "redirectUrl":"https://getfastform.com",
        "type":"web"
    }
    ```
    </CodeGroup>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="PUT" label="/api/v1/management/forms/<form-id>">

    ```bash {{ title: 'cURL' }}
    curl -X POST https://app.fastform.com/api/v1/management/forms/<form-id> \
     --header 'Content-Type: application/json' \
     --header 'x-api-key: <your-api-key>' \
     -d '{"name": "My renamed Form"}'
    ```
...
## Delete Form by ID {{ tag: 'DELETE', label: '/api/v1/management/forms/<form-id>' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="DELETE" label="/api/v1/management/forms/<form-id>">
