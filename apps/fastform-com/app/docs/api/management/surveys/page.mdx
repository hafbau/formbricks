...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/surveys' \
    --header \
...
## Get Form by ID {{ tag: 'GET', label: '/api/v1/management/surveys/<form-id>' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/api/v1/management/surveys/<form-id>">

    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/surveys/<form-id>' \
    --header \
    'x-api-key: <your-api-key>'
    ```
...
## Create Form {{ tag: 'POST', label: '/api/v1/management/surveys' }}
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://app.fastform.com/api/v1/management/surveys/ \
...
## Update Form by ID {{ tag: 'PUT', label: '/api/v1/management/surveys/<form-id>' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="PUT" label="/api/v1/management/surveys/<form-id>">

    ```bash {{ title: 'cURL' }}
    curl -X POST https://app.fastform.com/api/v1/management/surveys/<form-id> \
     --header 'Content-Type: application/json' \
     --header 'x-api-key: <your-api-key>' \
...
## Delete Form by ID {{ tag: 'DELETE', label: '/api/v1/management/surveys/<form-id>' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="DELETE" label="/api/v1/management/surveys/<form-id>">
