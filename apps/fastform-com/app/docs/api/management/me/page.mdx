...
export const metadata = {
  title: "Fastform Me API: Fetch your environment details",
  description:
    "Dive into Fastform' Me API within the Public Client API suite. Seamlessly fetch your own current environment details.",
};
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/me' \
    --header \
