...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/responses' \
    --header \
      ...
      "data":[
        {
            ...
            "formId": "cln8k0tqu00p7z87nqr4thi3k",
            "finished": true,
            "data": {
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/responses/<response-id>' \
    --header \
    'x-api-key: <your-api-key>'
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://app.fastform.com/api/v1/management/resposnes/<response-id> \
