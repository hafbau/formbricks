...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/action-classes' \
    --header \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl --location \
    'https://app.fastform.com/api/v1/management/action-classes/<action-class-id>' \
    --header \
    'x-api-key: <your-api-key>'
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X POST https://app.fastform.com/api/v1/management/action-classes/ \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://app.fastform.com/api/v1/management/action-classes/<action-class-id> \
     --header 'x-api-key: <your-api-key>'
    ```
