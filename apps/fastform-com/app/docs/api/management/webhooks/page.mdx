...
Webhooks are tied to a specific Fastform environment. Once set, a webhook will receive updates from all surveys within this environment. This makes it easy to manage your data flow and ensure that all relevant updates are caught by the webhook.
  ...
  <Col>
    ...
    <Properties>
      ...
      <Property name="surveyIds" type="string[]">
        List of form IDs that will trigger the webhook. If not provided, the webhook will be triggered for all surveys.
      </Property>
    </Properties>
...
| surveyIds  | no       | -       | List of form IDs that will trigger the webhook. If not provided, the webhook will be triggered for all surveys. |
...
| data.surveyId         | String  | The identifier of the form associated with this response.                                                                                    |
