...
| IS_FORMBRICKS_CLOUD         | Uses Fastform Cloud if set to `1`                                                     | optional                                                |                                                                         |
...
| Variable                                           | Description                                                     | Required | Default |
| -------------------------------------------------- | --------------------------------------------------------------- | -------- | ------- |
| NEXT_PUBLIC_FORMBRICKS_API_HOST                    | Host for the Fastform API.                                    | optional |         |
| NEXT_PUBLIC_FORMBRICKS_ENVIRONMENT_ID              | If you already have a preset environment ID of the environment. | optional |         |
| NEXT_PUBLIC_FORMBRICKS_ONBOARDING_SURVEY_ID        | If you already have an onboarding form ID to show new users.  | optional |         |
...
| NEXT_PUBLIC_FORMBRICKS_COM_ENVIRONMENT_ID          | Environment ID for Fastform (if you already have one)         | optional |         |
| NEXT_PUBLIC_FORMBRICKS_COM_DOCS_FEEDBACK_SURVEY_ID | Form ID for the feedback form on the docs site.             | optional |         |
| NEXT_PUBLIC_FORMBRICKS_COM_API_HOST                | Host for the Fastform API.                                    | optional |         |
