export const metadata = {
  title: "Configure Fastform with External auth providers",
  description:
    "Set up and integrate multiple external authentication providers with Fastform. Our step-by-step guide covers Google OAuth and more, ensuring a seamless login experience for your users.",
};
...
Integrating Google OAuth with your Fastform instance allows users to log in using their Google credentials, ensuring a secure and streamlined user experience. This guide will walk you through the process of setting up Google OAuth for your Fastform instance.

### Requirements

- A Google Cloud Platform (GCP) account.
- A Fastform instance running and accessible.
...
3. **Configure OAuth Consent Screen**:
   ...
   - Fill in the necessary details and under **Authorized domains**, add the domain where your Fastform instance is hosted.
...
6. **Restart Your Fastform Instance**:
   - **Note:** Restarting your Docker containers may cause a brief period of downtime. Plan accordingly.
   - Once the environment variables have been updated, it's crucial to restart your Docker containers to apply the changes. This ensures that your Fastform instance can utilize the new Google OAuth configuration for user authentication. Here's how you can do it:
