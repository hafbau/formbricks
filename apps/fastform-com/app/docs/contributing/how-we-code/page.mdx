...
The public endpoints of the Client API are used by the link survey and `fastform-js` to send responses and displays to fastform. Client APIs can be found in `apps/web/app/api/v1/client`
