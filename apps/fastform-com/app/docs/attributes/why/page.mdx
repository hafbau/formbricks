export const metadata = {
  ...
  description:
    "Dive into the importance of attributes in surveys. Learn how key-value pairs can significantly improve survey targeting, enhance feedback quality, and guide data-driven decisions with Fastform.",
};
...
Attributes are sent from your application to Fastform and are associated with the current user. We store it in our database and allow you to use it the next time you create a survey.
