...
const FAQ_DATA = [
  {
    ...
    answer: () => (
      <>
        The environment ID is a unique identifier associated with each Environment in Fastform, distinguishing
        between different setups like production, development, etc.
      </>
    ),
  },
  {
    question: "How can I implement authentication for the Fastform API?",
    answer: () => (
      <>
        Fastform provides 2 types of API keys for each environment ie development and production. You can
        generate, view, and manage these keys in the Settings section on the Admin dashboard. Include the API
        key in your requests to authenticate and gain access to Fastform functionalities.
      </>
    ),
  },
  {
