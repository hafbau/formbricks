...
const gettingStarted = [
  ...
  },
  {
    ...
    name: "Next.js App",
    description: "Integrate the Fastform SDK into a Next.js application with the new app directory",
  },
  {
    href: "/docs/self-hosting/deployment",
    name: "Self Host Deployment",
    description: "Host Fastform on your own servers, check out our dedicated Self-hosted Documentation page.",
  },
  {
