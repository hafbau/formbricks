  ...
  return (
    <div>
      ...
      <div className="h-80 max-w-lg px-4 sm:max-w-lg md:max-w-lg">
        {activeTab === "npm" ? (
          <>
            <CodeBlock>npm install @fastform/js</CodeBlock>

            <CodeBlock>{`import fastform from "@fastform/js";
...
!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://unpkg.com/@fastform/js@^1.2.0/dist/index.umd.js";var e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(t,e),setTimeout(function(){window.fastform.init("claDadXk29dak92dK9","https://app.fastform.com")},500)}();
</script>`}</CodeBlock>
        ) : null}
      </div>
    </div>
