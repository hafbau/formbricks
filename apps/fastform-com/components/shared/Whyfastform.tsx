...
const features = [
  {
    name: "Futureproof",
    description: "Form needs change. With Fastform you’ll avoid island solutions right from the start.",
  ...
  {
    name: "Extendable",
    description: "Even though we try, we cannot build every single integration. With Fastform, you can.",
