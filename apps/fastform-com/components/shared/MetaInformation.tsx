...
export default function MetaInformation({
  ...
  return (
    <Head>
      ...
      <link rel="canonical" href="https://getfastform.com/" />
      ...
      <meta property="og:site_name" content="Fastform Privacy-first Experience Management Solution" />
      <meta property="article:publisher" content="Fastform GmbH" />
      ...
      <meta name="twitter:site" content="@fastform" />
      <meta name="twitter:creator" content="@fastform" />
      <meta name="twitter:title" content="Fastform | Privacy-first Experience Management" />
      <meta
