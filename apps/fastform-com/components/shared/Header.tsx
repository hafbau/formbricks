...
export default function Header() {
  ...
  return (
    <Popover className={`${stickyNavClass}`} as="header">
      {/*       <a href="https://www.producthunt.com/posts/fastform" target="_blank">
      ...
      <div className="flex items-center justify-between px-4 py-6 sm:px-6 md:justify-start ">
        <div className="flex w-0 flex-1 justify-start">
          <Link href="/">
            <span className="sr-only">Fastform</span>
 ...
 */}
        ...
        <div className="hidden flex-1 items-center justify-end md:flex">
          ...
          <Button
            ...
            <Image
              src={GitHubMarkDark}
              alt="GitHub Sponsors Fastform badge"
              width={24}
          ...
          <Button
            ...
            onClick={() => {
              router.push("https://app.fastform.com");
          ...
          <div className="dark:divide-slate divide-y-2 divide-slate-100 rounded-lg bg-slate-200 shadow-lg ring-1 ring-black ring-opacity-5 dark:divide-slate-700 dark:bg-slate-800">
            ...
            <div className="px-5 py-6">
              <div className="flex flex-col space-y-5 text-center text-sm dark:text-slate-300">
                ...
                <Button
                  variant="primary"
                  onClick={() => router.push("https://app.fastform.com/auth/signup")}
