    ...
    () => [
      ...
      },
      {
        ...
        links: [
          {
            name: "GDPR & CCPA",
            href: "https://getfastform.com/gdpr",
            icon: LinkIcon,
            target: "_blank",
          ...
          {
            name: "Privacy",
            href: "https://getfastform.com/privacy",
            icon: LinkIcon,
            target: "_blank",
            hidden: !isFastformCloud,
          },
          {
            name: "Terms",
            href: "https://getfastform.com/terms",
            icon: LinkIcon,
            target: "_blank",
            hidden: !isFastformCloud,
          },
          {
            name: "License",
            href: "https://github.com/hafbau/formbricks/blob/main/LICENSE",
            icon: LinkIcon,
            target: "_blank",
            hidden: false,
          },
