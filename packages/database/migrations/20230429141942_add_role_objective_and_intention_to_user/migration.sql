...
-- CreateEnum
CREATE TYPE "Intention" AS ENUM ('form_user_segments', 'form_at_specific_point_in_user_journey', 'enrich_customer_profiles', 'collect_all_user_feedback_on_one_platform', 'other');
