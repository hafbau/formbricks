...
ADD COLUMN     "billing" JSONB NOT NULL DEFAULT '{"stripeCustomerId": null, "features": {"inAppForm": {"status": "inactive", "unlimited": false}, "linkForm": {"status": "inactive", "unlimited": false}, "userTargeting": {"status": "inactive", "unlimited": false}}}';
